...
export const createTeam = (newTeam) =>
  API.post("/my-teams/create-team", newTeam);
export const editTeam = (teamId, team) =>
  API.patch(`/my-teams/${teamId}/edit-team`, team);
export const deleteTeam = (teamId) =>
  API.delete(`/my-teams/${teamId}/edit-team`);
export const joinTeam = (teamCode) =>
  API.patch(`/my-teams/join-team/${teamCode}`);

// Match API
export const getMatches = (teamId) => API.get(`/my-teams/${teamId}/matches`);
export const createMatch = (newMatch) =>
  API.post("/matches/create-match", newMatch);
...
export const editPlayer = (id, player) => API.post(`/player/${id}/edit`, player);

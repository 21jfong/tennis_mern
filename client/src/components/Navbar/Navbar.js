          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              <MenuItem onClick={handleCloseNavMenu}>
                <Typography sx={{ textAlign: 'center' }} component={Link} to='/my-teams'>My Teams</Typography>
              </MenuItem>
            </Menu>
          </Box>
          <Typography
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
                ...
                <MenuItem onClick={handleCloseUserMenu}>
                  {user ? (<Typography sx={{ textAlign: 'center' }} size="sm" variant="contained" color="secondary" onClick={logout}>Log out</Typography>) :
                    (<Typography sx={{ textAlign: 'center' }} component={Link} size="sm" to="/auth" variant="contained" color="secondary">Sign in</Typography>)}
                </MenuItem>
              </Menu>
            </Box>
          </Box>
